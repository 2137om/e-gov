<?php
	...
	if(isset($_GET['btnLogin']))
	{
		...
		$sql = "SELECT * FROM agent1 where aa_mobile='{$_GET['txtMobile']}' and aa_password='{$_GET['txtPassword']}'";
		...
		if($result->num_rows>0)
		{
			...
			$_SESSION["type"] = "Agent";
			$_SESSION["aa_name"] = $row['aa_name'];
			$_SESSION["aa_areaid"] = $row['aa_areaid'];

			$sql = "SELECT * FROM areas where a_id='{$_SESSION['aa_areaid']}'";
			
			$result1 = $conn->query($sql);
			if($result1->num_rows>0)
			{
				$row2=$result1->fetch_assoc();
				$_SESSION["area"] = $row2['a_area'];
			}
                ...
                <div class="col-lg-12">
                    <form method="GET" name="myForm" onsubmit="return validateForm()">
						...
						<div class="form-group">
							<div class="col-sm-5 col-sm-offset-4">
								<br>
								<a href="agentreg.php" style="color:white;">
