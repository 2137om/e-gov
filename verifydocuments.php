            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll">
                        <a href="#about">Hi... <?php echo "{$_SESSION['aa_name']}" ?></a>
                    </li>
					<li class="page-scroll">
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
					 <div class="row">
				<span>Area : </span> <?php echo "{$_SESSION['area']}" ?>
				 <form method="GET">
                    <div class="form-group">
						<div class="col-sm-5 col-sm-offset-4">
							<input type="text" name="txtAadhar" id="txtAadhar" class="form-control" placeholder="Unique Identification"/>
						</div>
						<div class="form-group">
							<div class="col-sm-5 col-sm-offset-4">
								<br>
					...
					<div class="row">
						...
						<?php
							if (isset($_GET['txtAadhar']))
							{
								...
								$sql = "SELECT c.c_id, c.c_fullname, c.c_mobile, c.c_email, p.p_area, p.p_pincode, cc.c_category, c.c_dob, c.c_aadhar, c.c_gender, a.a_area FROM candidates as c, categories as cc, areas as a, pincodes as p
...
WHERE d.`d_id`=od.od_id and d.d_candidateid=c.c_id and d.d_verified=0 and  c.c_aadhar='{$_GET['txtAadhar']}' and d.d_areaid='{$_SESSION['aa_areaid']}'";
								...
								<table width=100%>
									<tr>
										<td width="20%">
											...
											<br>
		<a style="color:red;" href="removedocumentag.php?d_did=<?php echo "{$row['d_did']}" ?>&aadhar=<?php echo "{$_GET['txtAadhar']}" ?>"> Remove</a> 
		<a style="color:red;" href="verifydoc.php?d_did=<?php echo "{$row['d_did']}" ?>&aadhar=<?php echo "{$_GET['txtAadhar']}" ?>"> Verify</a>
