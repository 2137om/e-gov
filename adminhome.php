        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll">
                        <a href="sendnotifications.php">Send Notifications</a>
                    </li>
                    <li class="page-scroll">
						...
						<div class="panel-heading">
							...
							<?php
								...
								if($result->num_rows>0)
								{
									...
									{
										echo "<font style=\"color:#18BC9C\">{$row['n_date']}</font><br><b>{$row['n_title']}</b><br>{$row['n_emailtext']}<br><a href=\"removenotification.php?n_id={$row['n_id']}\">Remove</a><br><a href=\"{$row['n_pdflink']}\">More Details</a><hr>";
									}
								}
								$conn->close();
							?>
