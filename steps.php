        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll">
                        <a href="#about">Agent Login</a>
                    </li>
					<li class="page-scroll">
                        <a href="#about">Candidate Login</a>
                    </li>
                    <li class="page-scroll">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills"> #1 Fill the online form</span>
						<br>
						<br>
						<span class="skills"> #2 Upload your original documents scan copy</span>
						<br>
                        <br>
                        <span class="skills"> #3 Get verified by the Agent in your area</span>
						<br>
