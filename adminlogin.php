<?php
	if(isset($_GET['btnLogin']))
	{
		...
		$sql = "SELECT * FROM admin1 where a_userid='{$_GET['txtId']}' and a_password='{$_GET['txtPassword']}'";
                    ...
                    <form name="myForm" method="GET" onsubmit="return validateForm()">
						 <div class="form-group">
							 <div class="col-sm-5 col-sm-offset-4">
								<input type="text" name="txtId" id="txtId" class="form-control" placeholder="Mobile Number"/>		
							</div>
						 </div>
						 <div class="form-group">
							 <div class="col-sm-5 col-sm-offset-4">
